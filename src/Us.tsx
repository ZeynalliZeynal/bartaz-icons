...
const SvgUs = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <g clipPath='url(#US_svg__a)'>
      ...
      <path
        fill='#D80027'
        d='M11.478 12H24c0-1.083-.145-2.132-.414-3.13H11.478zM11.478 5.738h10.76a12 12 0 0 0-2.769-3.13h-7.991zM12 24c2.824 0 5.42-.976 7.47-2.609H4.53A11.95 11.95 0 0 0 12 24M1.761 18.26h20.477a12 12 0 0 0 1.348-3.13H.413c.3 1.116.758 2.167 1.348 3.13'
      />
      <path
        fill='#0052B4'
