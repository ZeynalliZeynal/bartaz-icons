...
const SvgLayer = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      fill='currentColor'
      d='m19.37 4.89-5.86-2.61c-.86-.38-2.16-.38-3.02 0L4.63 4.89c-1.48.66-1.7 1.56-1.7 2.04s.22 1.38 1.7 2.04l5.86 2.61c.43.19.97.29 1.51.29s1.08-.1 1.51-.29l5.86-2.61c1.48-.66 1.7-1.56 1.7-2.04s-.21-1.38-1.7-2.04'
    />
    <path
      fill='currentColor'
